...
@section('content')
                                        ...
                                        <tbody>
                                            @foreach ($attributes as $attribute)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('custom.option.by.attr', $attribute->uuid) }}"
    ...
    @include('admin.modals.custom.editAttribute')
    @include('admin.modals.custom.deleteAttribute')
@endsection

@push('scripts')
    <script src="{{ asset('assets/js/custom/custom_attribute.js') }}"></script>
